...
class TestDensityAnomalyScorer:
    ...
    def test_score_similar_windows(self) -> None:
        ...
        windows = [
            TextWindow(content="test", start_line=i, end_line=i, window_id=i) for i in range(5)
        ]
    ...
    def test_score_diverse_windows(self) -> None:
        ...
        windows = [
            TextWindow(content=f"test{i}", start_line=i, end_line=i, window_id=i) for i in range(6)
        ]
    ...
    def test_mmap_strategy_consistency(self) -> None:
        ...
        windows = [
            TextWindow(content=f"test{i}", start_line=i, end_line=i, window_id=i)
            for i in range(100)
        ]
...
class TestThresholder:
    ...
    def test_select_all_windows(self) -> None:
        ...
        windows = [
            TextWindow(content=f"test{i}", start_line=i, end_line=i, window_id=i) for i in range(10)
        ]
