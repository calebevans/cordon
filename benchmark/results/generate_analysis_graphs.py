...
def plot_sample_size_scaling(results_dir: Path, output_dir: Path):
    ...
    configs = {
        "50k": "50k/50k_w5_k10_p02",
        "100k": "100k/100k_w5_k10_p02",
        "250k": "250k/250k_w5_k10_p02",
        "500k": "500k/500k_w5_k10_p02",
        "1M": "1M/1M_w5_k10_p02",
    }
...
def plot_parameter_tuning(results_dir: Path, output_dir: Path):
    ...
    configs = {
        "Baseline\n(w5_k10_p02)": "50k/50k_w5_k10_p02",
        "Tuned\n(w2_k5_p02)": "50k/50k_w2_k5_p02",
    }
...
def plot_threshold_sensitivity(results_dir: Path, output_dir: Path):
    ...
    configs = {
        "p=0.02 (2%)": "50k/50k_w2_k5_p02",
        "p=0.05 (5%)": "50k/50k_w2_k5_p05/run_20251128_155039",
        "p=0.10 (10%)": "50k/50k_w2_k5_p10/run_20251128_162531",
    }
